...
//        }
//
//        public func requestFreeFeeLimits(for authority: String) -> Single<Relay.FeeLimitForAuthorityResponse> {
//            var url = FeeRelayer.feeRelayerUrl
//            if version > 1 {
//                url += "/v\(version)"
//            }
...
//                    }
//
//                    return try JSONDecoder().decode(Relay.FeeLimitForAuthorityResponse.self, from: data)
//                }
//        }
//
