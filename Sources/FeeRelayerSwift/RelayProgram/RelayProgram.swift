...
public enum RelayProgram {
    ...
    static func getUserTemporaryWSOLAddress(user: PublicKey, network: Network) throws -> PublicKey {
    ...
    static func getTransitTokenAccountAddress(
        user: PublicKey, transitTokenMint: PublicKey,
        network: Network
    ) throws -> PublicKey {
        try .findProgramAddress(
    ...
    static func topUpSwapInstruction(
        ...
        let userTemporarilyWSOLAddress = try getUserTemporaryWSOLAddress(
    ...
    public static func transferSolInstruction(
        ...
        .init(
            keys: [
                ...
                .writable(
                    publicKey: try getUserRelayAddress(user: userAuthorityAddress, network: network),
                    isSigner: false
                ),
    ...
    private static func topUpWithSPLSwapTransitiveInstruction(
        ...
        .init(
            keys: [
                ...
                .writable(publicKey: userSourceTokenAccount, isSigner: false),
                .writable(
                    publicKey: try getTransitTokenAccountAddress(user: userAuthority,
